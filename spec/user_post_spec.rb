...
describe UserPost do
  ...
  describe '#analysis' do
    let(:log_1) { Fabricate(:user_post_log, connect: '20', service: '20', dyno: 'web.2') }
    let(:log_2) { Fabricate(:user_post_log, connect: '20', service: '10', dyno: 'web.2') }
    let(:log_3) { Fabricate(:user_post_log, connect: '20', service: '10', dyno: 'web.2') }
    let(:log_4) { Fabricate(:user_post_log, connect: '10', service: '20', dyno: 'web.1') }
    let(:log_5) { Fabricate(:log, connect: '20', service: '20', dyno: 'web.3') }

    subject { UserPost.new }
